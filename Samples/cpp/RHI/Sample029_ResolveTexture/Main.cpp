...
public:
    ...
    std::u8string_view title() const override { return u8"Sample029 - ResolveTexture (Explicit 4x MSAA)"; }
protected:
    draco::Status onInit() override;
    void onRender() override;
    void onResize(draco::u32 w, draco::u32 h) override { recreateMsaaTarget(w, h); }
...
private:
    ...
    void recreateMsaaTarget(draco::u32 w, draco::u32 h);
...
void ResolveTextureSample::recreateMsaaTarget(draco::u32 w, draco::u32 h) {
...
draco::Status ResolveTextureSample::onInit() {
    ...
    if (sf::compileToModule(m_compiler, m_device, kShader, shaders::ShaderStage::Vertex,   u8"VSMain", u8"ResolveVS", m_vs) != draco::ErrorCode::Ok) return draco::ErrorCode::Unknown;
    if (sf::compileToModule(m_compiler, m_device, kShader, shaders::ShaderStage::Fragment, u8"PSMain", u8"ResolvePS", m_ps) != draco::ErrorCode::Ok) return draco::ErrorCode::Unknown;
